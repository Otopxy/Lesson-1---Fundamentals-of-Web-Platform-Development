...
pool.query(
    `INSERT INTO UserTemitope2021 
                 (COUNTRY, BUSINESS NAME, FIRST NAME, LAST NAME, EMAIL, PASSWORD, DEVELOPER, TERMS OF ACCEPTANCE)
                 VALUES 
                 ('NIGERIA', 'OTOPXY SOFTWARE SOLUTIONS', 'TEMITOPE', 'OLAJIDE', 'Otopxy@gmail.com', 'Babatope12#', 'YES', 'YES'),
                 ('GHANA', 'BABA SOLUTIONS', 'BABATOPE', 'SAMSON', 'Baba7@gmail.com', 'Babtope14#', 'YES', 'YES'),
                 ('SOUTH AFRICA', 'ELENIYAN LIMITED', 'OJOPAGOGO', 'BIDEN', 'OJObiden@gmail.com', 'Bidpagogo1#', 'YES', 'YES')                 
                 `,
    (err, res) => {
      if(err) {
